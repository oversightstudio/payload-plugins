...
| `onInitBehavior`           | `"createOnly" \| "deleteOnly" \| "createAndDelete" \| "none"` | `"none"` | Reconcile the Payload collection with all Mux assets at startup. Delete modes remove stale Payload entries only; they never delete Mux assets. |
